...
from LineDetection.LineDetection import LineDetector
import logging
...
class EKF(Node):
    ...
    def __init__(self) -> None:
        ...
        self.create_subscription(Odometry,"/odom",EKF.callback,10)
    ...
    def callback(msg):
        ...
        EKF.landmarks = LineDetector.seed_segments
        ...
        for i in range(len(LineDetector.seed_segments)-1):
            '''TODO -- sub the EKF.landmarks for the correct attribute calls'''
            # measurement model
        ...
        for i in range(len(EKF.landmarks) -1):
            ...
            for j_0 in range(0,len(old_landmarks)):
